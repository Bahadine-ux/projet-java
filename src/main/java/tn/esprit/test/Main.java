...
public class Main {
    public static void main(String[] args) {
        ...
        Reclamation reclamation = new Reclamation(0, "Problème de connexion", "En attente", motif.getType(), 1);
        ...
        Reclamation reclamation2 = new Reclamation(0, "Produit cassé", "Résolu", motif2.getType(), 1);
