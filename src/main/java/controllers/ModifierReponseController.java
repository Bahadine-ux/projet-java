...
public class ModifierReponseController {
    ...
    private void saveChanges() {
        ...
        try {
            ...
            Reclamation r = serviceReclamation.getById(reclamationId);
            Client client = serviceClient.getById(r.getId_client());
            System.out.println(client.getEmail());
            String recipientEmail = client.getEmail();
            String subject = "Réponse à votre réclamation #" + r.getId();
